...
This result is indicative of a partial success, the extension of the heuristic model for non-aliquot density to $k$-parent appears to be accurate for small values of $k$. However further work is required to understand the why the estimates diverge from observations as $k$ increases. Perhaps the assumptions like $s(\cdot)$ being a random map hold for the case of $k = 0$ but not for the general case, studying the validity of this assumption could be an avenue for future work.
...
\begin{table}[h!]
    ...
    \centerline{
        \begin{tabular}{l | lllllllllll}
            $\Delta_{k}$            & \multicolumn{1}{l}{$k = 0$} & \multicolumn{1}{l}{$k = 1$} & \multicolumn{1}{l}{$k = 2$} & \multicolumn{1}{l}{$k = 3$} & \multicolumn{1}{l}{$k = 4$} & \multicolumn{1}{l}{$k = 5$} & \multicolumn{1}{l}{$k = 6$} & \multicolumn{1}{l}{$k = 7$} & \multicolumn{1}{l}{$k = 8$} & \multicolumn{1}{l}{$k = 9$} & \multicolumn{1}{l}{$k = 10$} \\

            \hline

            $y = 10^{2}$            & 0.1438                      & 0.1625                      & 0.1039                      & 0.0496                      & 0.0195                      & 0.0066                      & 0.0020                      & 0.0005                      & 0.0001                      & 0.0000                      & 0.0000                       \\
            $y = 10^{3}$            & 0.1552                      & 0.1643                      & 0.1000                      & 0.0462                      & 0.0178                      & 0.0059                      & 0.0017                      & 0.0005                      & 0.0001                      & 0.0000                      & 0.0000                       \\
            $y = 10^{4}$            & 0.1611                      & 0.1653                      & 0.0982                      & 0.0445                      & 0.0169                      & 0.0056                      & 0.0016                      & 0.0004                      & 0.0001                      & 0.0000                      & 0.0000                       \\
            $y = 10^{5}$            & 0.1646                      & 0.1659                      & 0.0971                      & 0.0435                      & 0.0164                      & 0.0054                      & 0.0016                      & 0.0004                      & 0.0001                      & 0.0000                      & 0.0000                       \\
            $y = 10^{6}$            & 0.1669                      & 0.1663                      & 0.0964                      & 0.0428                      & 0.0160                      & 0.0052                      & 0.0015                      & 0.0004                      & 0.0001                      & 0.0000                      & 0.0000                       \\
